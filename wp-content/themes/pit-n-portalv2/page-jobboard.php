...
<div class="banner">
    <div class="banner-content">
        <h1>Job Vacancies at Pit N Portal</h1>
        <h4 class="banner-h4-top">WORKING AT PNP</h4>
        <h4 class="banner-h4-bottom">Current opportunities</h4>
    </div>
</div>
    ...
    <div class="intro">
        ...
        <div class="row job-board">
            <div class="col-md-8 page-central">
                ...
                <?php echo do_shortcode("[adlogic_filtered_search_results childrenRecruiterIds='recruiterId: 10853' template='job-template']"); ?>
                <?php echo do_shortcode("[adlogic_filtered_search_pagination childrenRecruiterIds='recruiterId: 10853']"); ?>
                <div class="eoi">
