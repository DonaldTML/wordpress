...
<head>
	...
	<title>Careers at City of Korvest - <?php the_title(); ?></title>
        ...
        <header class="header">
            <div class="header-content responsive-wrapper">
              <div class="header-logo">
                  <a href="https://www.korvest.com.au/" class="logo">
                      <img src="<?php echo get_template_directory_uri(); ?>/images/korvest-logo.png" />
                  </a>
              </div>
