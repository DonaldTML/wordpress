...
<body>
	...
	<nav class="jobboard-nav">
		<div class="navigation-container">
			<div class="nav-logo">
				<a href="https://www.lighthouse.vic.edu.au/"><img src="<?php echo get_template_directory_uri(); ?>/images/logo.svg" alt="" id="nav-logo"></a>
			</div>
			<div class="nav-buttons">
				<?php if (!$needCareerButton) { ?>
					<a href="https://www.lighthouse.vic.edu.au/" class="nav-button">Home</a>
				<?php } else { ?>
					<a href="https://jobboards.adlogic.com.au/lighthouse-christian-college/" class="nav-button">Job Search</a>
				<?php } ?>
