...
<style>
.search-bg {
    background: #333 url(/careers/wp-content/themes/directgroup/images/Jobs_Board_Banner.jpg) !important;
    padding: 3rem 0;
...
<div class="wrapper">
    ...
    <img src="https://careers.charlessturt.sa.gov.au/careers/wp-content/themes/directgroup/images/DirectGroupLogo.gif" class="w-100">
    </div>
</div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 mx-auto">
               <div class="search-sidebar">
                ...
                <div class="box-sidebar shadow">
                    ...
                    <hr>
                    <a href="https://external-jobboard.myrecruitmentplus.com/job-details/query/8976976"><button type="button" class="btn btn-success w-100 mb-2 shadow rounded">Register</button></a>
               </div>
            </div>
