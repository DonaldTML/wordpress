<section id="footer">
	<div class="container">
		<div class="row footer">
			<div class="col-lg-12">
				<p><a id="ml-link" href="https://myrecruitmentplus.com/" target="_blank">Recruitment Software</a> by <a id="ml-link" href="https://myrecruitmentplus.com/onboarding-software/" target="_blank">Martian Logic</a></p>
			</div>
		</div>
	</div>
</section>
...
<style>
	...
	.mrp-email-button {
		...
		border: 0px solid #73c8d9 !important;
		background-color: #73c8d9 !important;
		background-image: none !important;
		font-weight: normal !important;
		font-family: bill-bold !important;
	}
