<?php
	get_header();
	get_post();
	// Template Name: Front Page ext
?>
<style>
.search-bg {
    background: #333 url(/careers/wp-content/themes/CharlesSturt/images/Jobs_Board_Banner.jpg) !important;
    padding: 3rem 0;
...
<div class="wrapper">
    ...
    <img src="https://careers.charlessturt.sa.gov.au/careers/wp-content/themes/CharlesSturt/images/Jobs_Board_Banner.jpg" class="w-100">
    </div>
</div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 mx-auto">
               <div class="search-sidebar">
                ...
                <div class="box-sidebar shadow">
                    ...
                    <hr>
                    <a href="https://form.myrecruitmentplus.com/applicationform?jobId=1560178&source=10000&subSourceId=9999"><button type="button" class="btn btn-success w-100 mb-2 shadow rounded">Register</button></a>
               </div>
            </div>
