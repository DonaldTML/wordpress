...
<head>
	...
	<title>Careers at City of Charles Sturt - <?php the_title(); ?></title>
        ...
        <header class="header">
            <div class="header-content responsive-wrapper">
              <div class="header-logo">
                  <a href="https://www.charlessturt.sa.gov.au/" class="logo">
                      <img src="<?php echo get_template_directory_uri(); ?>/images/new-logo.png" />
                  </a>
              </div>
