...
class LinkedIn {
	...
	function getRequestToken()
	{
		...
		$this->request_token = new OAuthConsumer((isset($response_params['oauth_token'])?$response_params['oauth_token']:""), 
		(isset($response_params['oauth_token_secret'])?$response_params['oauth_token_secret']:""), 1);
	}
	...
	function getAccessToken($oauth_verifier)
	{
		...
		$response = $this->httpRequest($url, $headers, "GET");
		parse_str($response, $response_params);
		$this->access_token = new OAuthConsumer((isset($response_params['oauth_token'])?$response_params['oauth_token']:""), 
		(isset($response_params['oauth_token_secret'])?$response_params['oauth_token_secret']:""), 1);
	}
